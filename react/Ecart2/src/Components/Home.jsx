...
const Home = () => {
  ...
  return (
    <div className='bg-black '>
      ...
      <button className="btn btn-active btn-accent" onClick={()=> {handleCategory("furniture")}} > Furniture </button>
      ...
      <button className="btn btn-active btn-accent" onClick={()=> {handleCategory("groceries")}}>Grocery </button>
      <button className="btn btn-active btn-accent" onClick={()=> {handleCategory("beauty")}}> Beauty </button>
      </div>
    <div className=' flex justify-around flex-wrap  '>

      {
        products == null ? <ShimmerUI></ShimmerUI> : products.map((obj , idx  )=> {
